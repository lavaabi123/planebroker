    ...
    <div class="front-login-box login-sec py-5">
        ...
        <div class="container py-md-4">
				<div class="titleSec text-center mt-0 mb-4 mb-xl-5">
					<h3 class="title-xl text-black mb-2">Set Password</h3>
				</div>
				<div class="form-input">
                <?php echo $this->include('Common/_messages') ?>
                <?php echo form_open("providerauth/set-password-post", ['id' => 'form_safes', 'class' => '']); ?>
                <?php echo csrf_field() ?>
                <?php if (!empty($user)) : ?>
				...
				<div class="form-section">
                    <div class="form-group mb-3">
                        <input type="password" id="password" name="password" class="form-control form-input" value="<?php echo old("password"); ?>" placeholder="<?php echo trans("form_password"); ?>" required>
                    </div>
                    ...
                    <div class="d-grid mb-0 text-center">
                        <button class="btn btn-lg btn-primary w-100" type="submit"><i class="mdi mdi-login"></i> <?php echo trans("Submit"); ?> </button>
                    </div>
                <?php endif; ?>
                <?php echo form_close(); ?>
				</div>

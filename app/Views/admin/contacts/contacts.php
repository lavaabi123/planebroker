                                ...
                                <div class="col-sm-12">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php
												foreach ($contacts as $h => $provider_message) : ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"> <a href="javascript:void(0)" onclick="get_contact_messages('<?php echo html_escape($provider_message->id); ?>');"><?php echo trans('View Message'); ?></a></td>      
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                                        </table>

                                        ...
                                        <table class="table table-bordered table-striped">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <?php /* <th class="max-width-120"><?php echo trans('options'); ?></th> */ ?>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php foreach ($paginate['emails'] as $email) : ?>
                                                    <tr>
                                                        <td><?php echo clean_number($email['id']); ?></td>

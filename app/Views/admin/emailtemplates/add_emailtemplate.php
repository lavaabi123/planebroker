...
<div class="content-wrapper bg-grey">
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- Main row -->
            <?php echo form_open_multipart('admin/emailtemplates/add_emailtemplate_post', ['id' => 'form',  'class' => 'custom-validation needs-validation']); ?>
                ...
                <div class="col-lg-12 col-xl-12">
                    <div class="card card-primary card-outline card-outline-tabs">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control auth-form-input" placeholder="<?php echo trans("subject"); ?>" value="<?php echo old("subject"); ?>" required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-footer p-0 pt-3 clearfix" style="clear: both">
							...
							<p class="mb-0">Available Variables: <code>{user_name}</code>, <code>{email}</code>, <code>{phone}</code></p>
                        </div>
                        <!-- /.card -->
                    </div>
                </div>

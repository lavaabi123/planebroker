...
<div class="content-wrapper">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <?php else :  ?>
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo admin_url() ?>support"><?php echo trans('Support') ?></a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- Main row -->
            <?php echo form_open_multipart('admin/support/add_support_post', ['id' => 'form',  'class' => 'custom-validation needs-validation']); ?>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        <label class=" ml-0"><?php echo trans("Support Title"); ?><span class="required"> *</span></label>
                                        <input type="text" name="name" class="form-control auth-form-input" placeholder="<?php echo trans("Support Title"); ?>" value="<?php echo old("subject"); ?>" required>
                                    </div>
                                </div>
                            </div>

                            <div class="form-group mb-3">
                                <label class="control-label ml-0"><?php echo trans('Support Content'); ?><span class="required"> *</span></label>                               

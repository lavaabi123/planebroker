...
<div class="content-wrapper bg-grey">
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- Main row -->
            <?php echo form_open_multipart('admin/support/edit_support_post', ['id' => 'form', 'class' => 'custom-validation needs-validation']); ?>
                    ...
                    <div class="card card-primary card-outline card-outline-tabs">
                        ...
                        <div class="card-body p-0">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mb-3">
                                                <label><?php echo trans("subject"); ?><span class="required"> *</span></label>
                                                 <input type="text" name="name" class="form-control auth-form-input" placeholder="<?php echo trans("subject"); ?>" value="<?php echo html_escape($support->name); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control text-area" name="content" id="editor" placeholder="<?php echo trans('content'); ?>" required><?php echo html_escape($support->content); ?></textarea>

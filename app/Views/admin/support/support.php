        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6 d-flex">
                    <h1 class="m-0"><?php echo $title ?></h1><a class="permission_show" href="<?php echo admin_url() . 'support/add-support/'; ?>"><button type="button" class="btn small btn-primary ms-3"><i class="fa fa-plus pr-2"></i><?php echo trans("add"); ?></button></a>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-xl-12">
                    <div class="p-0">
                            <?php //echo $this->include('admin/support/_filter') ?>
                                ...
                                <div class="col-sm-12">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php foreach ($supports as $h => $support) : ?>
                                                    <tr>
                                                        <td><?php echo $support['name']; ?> </td>
                                                        <td><?php echo date("m-d-Y", strtotime($support['created_at'])); ?>
                                                        <td><?php echo ($support['status'] == 1) ? '<span class="badge bg-success">Active</span>' : '<span class="badge bg-danger">Inactive</span>'; ?> </td></td>
                                                        <td class="permission_show">
                                                            <div class="dropdown btn-group">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-animated">
                                                                    <?php if (is_admin()) : ?>
                                                                        <a class="dropdown-item" href="<?php echo admin_url() . 'support/edit-support/'; ?><?php echo html_escape($support['id']); ?>"><?php echo trans('edit'); ?></a>
                                                                        <div class="dropdown-divider"></div>
                                                                        <a class="dropdown-item" href="javascript:void(0)" onclick="delete_item('/admin/support/delete_support_post','<?php echo $support['id']; ?>','<?php echo trans('Are you sure you want to delete this support?'); ?>')"><?php echo trans('delete'); ?></a>
                                                                    <?php endif; ?>
                                                                </div>
                                                            </div>

...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- Main row -->
            <?php echo form_open_multipart('admin/testimonial/add_testimonial_post', ['id' => 'form',  'class' => 'custom-validation needs-validation']); ?>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        <label class=" ml-0"><?php echo trans("Name"); ?><span class="required"> *</span></label>
                                        <input type="text" name="name" class="form-control auth-form-input" placeholder="<?php echo trans("Testimonial Title"); ?>" value="<?php echo old("subject"); ?>" required>
                                    </div>
                                </div>
                            </div>

                            <div class="form-group mb-3">
                                <label class="control-label ml-0"><?php echo trans('Testimonial Content'); ?><span class="required"> *</span></label>                               

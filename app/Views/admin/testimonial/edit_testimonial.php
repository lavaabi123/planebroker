...
<div class="content-wrapper bg-grey">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <?php else :  ?>
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo admin_url() ?>testimonial"><?php echo trans('Testimonial') ?></a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- Main row -->
            <?php echo form_open_multipart('admin/testimonial/edit_testimonial_post', ['id' => 'form', 'class' => 'custom-validation needs-validation']); ?>
                ...
                <div class="col-lg-12 col-xl-12">
                    <div class="card card-primary card-outline card-outline-tabs">
                        ...
                        <div class="card-body p-0">
                                    <input type="hidden" name="id" value="<?php echo html_escape($testimonial->id); ?>">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mb-3">
                                                <label><?php echo trans("subject"); ?><span class="required"> *</span></label>
                                                 <input type="text" name="name" class="form-control auth-form-input" placeholder="<?php echo trans("subject"); ?>" value="<?php echo html_escape($testimonial->name); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control text-area" name="content" id="editor" placeholder="<?php echo trans('content'); ?>" required><?php echo html_escape($testimonial->content); ?></textarea>

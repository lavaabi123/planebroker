            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                  <h1 class="m-0"><?php echo $title ?> 
                    <a class="btn btn-primary" href="<?php echo admin_url() . 'add-listing/'; ?>"><?php echo trans('Add Listing'); ?></a>
                  </h1>                     
                </div><!-- /.col -->
                <div class="col-sm-6">
                                            ...
                                            <tbody>
												...
												?>
                                                    <tr>
                                                        <td><?php echo $u+1; ?></td>
                                                        <td>
                                                            <a href="<?php echo base_url('provider/'.$user['permalink'].'/'.base64_encode($user['id'])); ?>" target="_blank"><?php echo $user['display_name']; ?></a>
                                                        </td>         

...
<div class="content-wrapper">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <?php else :  ?>
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo admin_url() ?>support"><?php echo trans('Video') ?></a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- Main row -->
            <?php echo form_open_multipart('admin/video/add_video_post', ['id' => 'form',  'class' => 'custom-validation needs-validation']); ?>

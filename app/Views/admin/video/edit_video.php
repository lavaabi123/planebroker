...
<div class="content-wrapper bg-grey">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <?php else :  ?>
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo admin_url() ?>video"><?php echo trans('Video') ?></a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- Main row -->
            <?php echo form_open_multipart('admin/video/edit_video_post', ['id' => 'form', 'class' => 'custom-validation needs-validation']); ?>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mb-3">
                                                <label><?php echo trans("subject"); ?><span class="required"> *</span></label>
                                                 <input type="text" name="name" class="form-control auth-form-input" placeholder="<?php echo trans("subject"); ?>" value="<?php echo html_escape($video->name); ?>" required>
                                            </div>
                                        </div>
									 ...
									 <div class="row">
										<div class="col-6">
											<div class="form-group mb-3">
												...
												<input type="text" name="video_url" class="form-control auth-form-input" placeholder="<?php echo trans("video url"); ?>" value="<?php echo html_escape($video->video_url); ?>" required>
											</div>
										</div>
									</div>
						<div class="row">
							<div class="col-6">
								<div class="form-group mb-3">
									...
									<option value="2" <?php echo ($video->status == 2) ? 'selected':''; ?>>Inactive</option>
									</select>
								</div>
							</div>
						</div>

						...
						<td>
							...
							<div class="mailcontent" style="line-height: 26px;font-size: 14px;">
								...
								<p style='text-align: center;margin-top: 30px;'>
									<a href="<?php echo base_url('auth/reset-password'); ?>?token=<?php echo $token; ?>" style='font-size: 14px;text-decoration: none;padding: 14px 40px;background-color: #000;color: #ffffff !important; border-radius: 3px;'>

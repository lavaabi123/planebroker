...
<?php } ?>
		<div class="container py-5 py-sm-5 text-center">
			...
			<?php endif; ?>				
			<?php if (!empty(get_general_settings()->tiktok_url) && get_general_settings()->tiktok_url != '#') : ?>
			<a href="<?php echo html_escape(get_general_settings()->tiktok_url); ?>" target="_blank" style="color: transparent;margin-right: 5px;">
				<img src="<?php echo base_url(); ?>/assets/img/tiktok.png" alt=""/>
			</a>
			<?php endif; ?>

...
<head>
    ...
    <!-- Style CSS -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>/assets/frontend/css/style.css?version=1.11">    <!-- Responsive  CSS -->
...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <symbol id="grid" viewBox="0 0 16 16">
		...
		<div class="container-fluid px-xl-5 d-flex justify-content-center">
			<ul class="navbar-nav ms-sm-auto align-items-center d-flex flex-row text-white gap-4">
				...
				<?php if (session()->get('vr_sess_logged_in') != TRUE) : ?>
					<li class="nav-item"><a class="nav-link text-white" href="<?php echo base_url('user-signup'); ?>"><img src="<?= base_url('assets/img/signup.png') ?>" alt="signup" width="20" height="20" /> Sign Up</a></li>
					<li class="nav-item d-none d-sm-block"><a class="nav-link text-white" href="<?php echo base_url('providerauth/login'); ?>"><svg class="bi mx-auto" width="20" height="20"><use xlink:href="#people-circle"></use></svg> Login</a></li>
				...
				<?php if (session()->get('vr_sess_logged_in') != TRUE) : ?>
				  <li class="nav-item d-block d-sm-none">
					<a class="nav-link fs-7 fw-bold" href="<?php echo base_url('pricing'); ?>">BECOME A Plane Broker</a>
				  </li>
				<?php endif; ?>
			</ul>
		</div>
		...
		<div class="row w-100 m-auto align-items-center justify-content-between">
		  ...
		  <div class="collapse navbar-collapse col-sm-10" id="navbarCollapse">
			<ul class="navbar-nav ms-auto mb-2 mb-md-0 align-items-center flex-wrap-reverse justify-content-end">
			  ...
			  <li class="nav-item">
				<a class="nav-link" href="<?= base_url('/listings/aircraft-for-sale') ?>">Aircraft for Sale</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link" href="<?= base_url('/listings/maintenance-services') ?>">Maintenance Services</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link" href="<?= base_url('/listings/accessories') ?>">Accessories</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link" href="<?= base_url('/listings/real-estate') ?>">Real Estate</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link" href="<?= base_url('/about-us') ?>">Wanted</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link" href="<?= base_url('/about-us') ?>">Education</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link" href="<?= base_url('/about-us') ?>">About Us</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link" href="<?= base_url('/providers') ?>">Sell Today</a>
			  </li>
			  <li class="nav-item d-block d-sm-none">
				<?php if (session()->get('vr_sess_logged_in') != TRUE) : ?>
	...
	<div class="footer2 text-center text-sm-start">
...
#gdpr-cookie-message input[type="checkbox"] {
	...
	<?php } ?>
	<script src="<?php echo base_url(); ?>/assets/frontend/js/provider.js?version=1.5"></script>
